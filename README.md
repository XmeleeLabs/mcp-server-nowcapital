...
*   **Risk Analysis:** "Run a Monte Carlo simulation for my retirement plan if I spend $4500 per month. I have $850k in savings and I am 65 years old with max CPP and OAS. Use the start_monte_carlo_simulation tool." (Note: This process typically takes 5-15 seconds).
    *   *Default Economic Model:* Simulations use the **FP Canada Baseline** assumptions: 4.5% Expected Returns, 2.3% Inflation (CPI), 9% Returns Std Dev, 1.2% CPI Std Dev, and -0.05 Correlation.
